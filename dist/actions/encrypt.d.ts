...
export type EncryptionType = 'ebool' | 'euint8' | 'euint16' | 'euint32' | 'euint64' | 'euint128' | 'euint256' | 'eaddress';
 ...
 */
export declare const getEncryptionMethod: (type: string) => "addBool" | "add8" | "add16" | "add32" | "add64" | "add128" | "add256" | "addAddress";
/**
 ...
 */
export declare function encrypt<config extends FhevmConfig>(config: config, parameters: EncryptParameters): Promise<EncryptReturnType>;
/**
 ...
 */
export declare function encryptWith<config extends FhevmConfig>(config: config, parameters: {
    instance: FhevmInstance;
    contractAddress: `0x${string}`;
    userAddress: `0x${string}`;
