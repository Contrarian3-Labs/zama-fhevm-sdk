 ...
 */
export type OneOf<union extends object, keys extends KeysOf<union> = KeysOf<union>> = union | {
    [key in keys]: ExclusiveUnion<union, key>;
}[keys];
type KeysOf<type> = type extends type ? keyof type : never;
type ExclusiveUnion<union, key extends KeysOf<union>> = union extends unknown ? union & {
    [k in Exclude<KeysOf<union>, key>]?: never;
} : never;
/**
