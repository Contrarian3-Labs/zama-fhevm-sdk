...
const InMemoryStorageKey = Symbol('InMemoryStorage');
/**
 ...
 * ```
 */
export function provideInMemoryStorage() {
...
export function useInMemoryStorage() {
    ...
    if (!storage) {
        throw new Error('useInMemoryStorage must be used within a component tree where provideInMemoryStorage() was called. ' +
